...
from
    (
    select k_person2id as id, 1 as dist from knows, person where k_person1id = 4398046511333 and p_personid = k_person2id and p_firstname = 'Jose'
    union all
    select b.k_person2id as id, 2 as dist from knows a, knows b, person
    where a.k_person1id = 4398046511333
      and b.k_person1id = a.k_person2id
      and p_personid = b.k_person2id
      and p_firstname = 'Jose'
      and p_personid != 4398046511333 -- excluding start person
    union all
